...
public class BlockManager : MonoBehaviour
{
    ...
    [Header("Assign your shadow object here")]
    ...
    void InitGame()
    {
        ...
        var color = GetCurrentColor(randomColorOffset);
        currentBlock = preBlock = SpawnBlock(currentBlockScale, new Vector3(0f, -1f, 0f), color);
    ...
    GameObject SpawnBlock(Vector3 scale, Vector3 position, UnityEngine.Color color)
    {
    ...
    UnityEngine.Color GetCurrentColor(float offset)
    {
        ...
        return UnityEngine.Color.Lerp(gameData.colorPalette[colorI1], gameData.colorPalette[colorI2], middleValue);
    }
}
